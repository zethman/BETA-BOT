...
export function getMetadataPda(mint) {
    const [pda] = PublicKey.findProgramAddressSync([Buffer.from("metadata"), METADATA_PROGRAM_ID.toBuffer(), mint.toBuffer()], METADATA_PROGRAM_ID);
    return pda;
}
function readMetaplexString(data, offset, bufSize) {
 ...
 */
function parseToken2022Metadata(mint, accountData) {
    try {
